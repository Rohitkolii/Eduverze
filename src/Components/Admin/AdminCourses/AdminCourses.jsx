...
const AdminCourses = () => {
  ...
  const handeSetChapters = (e) => {
    e.preventDefault();
    if (
      chapterData.chapter_name &&
      chapterData.chapter_url &&
      chapterData.chapter_duration
    ) {
      ...
      return alert("Plese Enter Chapter Data!");
    }
  };

  const removeChips = (i) => {
    const newchips = coursepointsarr.filter(
      (elm, index, arr) => arr.indexOf(elm) !== i
    );
  ...
  const {
    ...
    onSubmit: async (value, action) => {
      ...
      formData.append("courses_arr", JSON.stringify(chapters));
    ...
    //     formData.append(`courses_arr[${index}]`, JSON.stringify(c));
    //   });

      try {
        const response = await fetch(
          "http://localhost:3001/api/courses/addcourse",
          {
            method: "POST",
            body: formData,
          }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={Styles.rowin}>
            <div className={Styles.colin}>
              ...
              {touched.course_name && errors.course_name ? (
                <p className={Styles.errtext}>{errors.course_name}</p>
              ) : null}
            </div>
            <div className={Styles.colin}>
              ...
              <input
                ...
                onBlur={handleBlur}
              />
              {touched.course_category && errors.course_category ? (
                <p className={Styles.errtext}>{errors.course_category}</p>
              ) : null}
            </div>
            <div className={Styles.colin}>
              ...
              <input
                ...
                onBlur={handleBlur}
              />
              {touched.course_duration && errors.course_duration ? (
                <p className={Styles.errtext}>{errors.course_duration}</p>
              ) : null}
            </div>
            <div className={Styles.colin}>
              <label htmlFor="course_price">Price</label>
              <input
                placeholder="Enter course price in Rs"
                type="text"
                name="course_price"
                id="course_price"
                ...
                onBlur={handleBlur}
              />
              {touched.course_price && errors.course_price ? (
                <p className={Styles.errtext}>{errors.course_price}</p>
              ) : null}
            </div>
            <div className={Styles.colin}>
              ...
              <input
                ...
                id="course_discount"
                value={values.course_discount}
                onChange={handleChange}
                onBlur={handleBlur}
              />
              {touched.course_discount && errors.course_discount ? (
                <p className={Styles.errtext}>{errors.course_discount}</p>
              ) : null}
            </div>
            <div className={Styles.colin}>
              ...
              <input
                ...
                id="course_publisher"
                value={values.course_publisher}
                onChange={handleChange}
                onBlur={handleBlur}
              />
              {touched.course_publisher && errors.course_publisher ? (
                <p className={Styles.errtext}>{errors.course_publisher}</p>
              ) : null}
            </div>
          </div>
          {/* <div className={Styles.colin}>
          ...
          <div className={Styles.colin}>
            ...
            {touched.course_description && errors.course_description ? (
              <p className={Styles.errtext}>{errors.course_description}</p>
            ) : null}
          </div>
          <div className={Styles.colin}>
          ...
          <div className={Styles.colin}>
            {coursepointsarr?.map((point, i) => (
              <div className={Styles.chips} key={i}>
                <p>{point}</p>
                <button type="button" onClick={() => removeChips(i)}>
                  x
                </button>
              </div>
            ))}
          ...
          <div className={Styles.colin}>
            <button
              onClick={handkecoursepoints}
              style={{ width: "fit-content", padding: "15px 50px" }}
            >
              Add Course Point
            </button>
          </div>
          ...
          <div className={Styles.rowin}>
            <div className={Styles.colin}>
              <label htmlFor="coursepoints">Chapter Name</label>
              <input
            ...
            <div className={Styles.colin}>
              <label htmlFor="coursepoints">Chapter URL</label>
              <input
                value={chapterData.chapter_url}
                onChange={(e) =>
                  setChapterData((prev) => ({
                    ...prev,
            ...
            <div className={Styles.colin}>
              <label htmlFor="coursepoints">Chapter Duration</label>
              <input
                value={chapterData.chapter_duration}
                onChange={(e) =>
                  setChapterData((prev) => ({
                    ...prev,
                    chapter_duration: e.target.value,
                  }))
                }
                type="text"
                name=""
            ...
            <div className={Styles.colin}>
              {chapters?.map((ch, i) => (
                <div className={Styles.chips} key={i}>
                  <p>
                    {ch.chapter_name} : {ch.chapter_url} : {ch.chapter_duration}
                  </p>
          ...
          <div className={Styles.file}>
            ...
            <input
              ...
              id="course_thumbnail"
              onChange={(e) =>
                setFieldValue("course_thumbnail", e.currentTarget.files[0])
              }
            />
      ...
      <div className={Styles.courses}>
        <div className={Styles.coursegrid}>
          {courses?.map((elm, index) => (
            <CourseCard key={index} courseData={elm} />
          ))}
        </div>
      </div>
    </section>
